import{_ as e}from"./plugin-vue_export-helper-c27b6911.js";import{r as t,o as p,c as o,b as n,d as s,e as c,a as l}from"./app-747924c3.js";const i={},u=n("h1",{id:"_208-实现-trie-前缀树",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#_208-实现-trie-前缀树","aria-hidden":"true"},"#"),s(" 208. 实现 Trie (前缀树)")],-1),r={href:"https://leetcode.cn/problems/implement-trie-prefix-tree/",target:"_blank",rel:"noopener noreferrer"},d=l(`<p>Trie（发音类似 &quot;try&quot;）或者说 前缀树 是一种树形数据结构，用于高效地存储和检索字符串数据集中的键。这一数据结构有相当多的应用情景，例如自动补完和拼写检查。</p><p>请你实现 <code>Trie</code> 类：</p><p><code>Trie()</code> 初始化前缀树对象。 <code>void insert(String word)</code> 向前缀树中插入字符串 word 。 <code>boolean search(String word)</code> 如果字符串 word 在前缀树中，返回 <code>true</code>（即，在检索之前已经插入）；否则，返回 <code>false</code> 。 <code>boolean startsWith(String prefix)</code> 如果之前已经插入的字符串 word 的前缀之一为 prefix ，返回 <code>true</code> ；否则，返回 <code>false</code> 。</p><p>示例:</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>输入
